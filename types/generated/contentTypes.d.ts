...
export interface ApiServiceGuideServiceGuide
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_guides';
  info: {
    displayName: 'Service Guide';
    pluralName: 'service-guides';
    singularName: 'service-guide';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-guide.service-guide'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    steps: Schema.Attribute.Component<'services.step', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.Component<'services.service', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSupportPageSupportPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    hero: Schema.Attribute.Component<'sections.hero-banner', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::service-guide.service-guide': ApiServiceGuideServiceGuide;
